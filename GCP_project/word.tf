...
sed -i -e "s/database_name_here/${google_sql_database.wordpress.name}/" /var/www/html/wp-config.php
sed -i -e "s/username_here/${google_sql_user.users.name}/" /var/www/html/wp-config.php
sed -i -e "s/password_here/${var.db_password}/" /var/www/html/wp-config.php
